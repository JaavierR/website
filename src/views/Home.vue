        ...
        <div class="my-10 space-y-4">
            ...
            >
                <div class="w-full space-y-2 md:w-8/12">
                    <div
                        class="text-xl font-semibold dark:text-white md:text-3xl"
                    >
                        <h2>Self taught</h2>
                        <h2>Full-stack web developer and ML enthusiast</h2>
                    </div>
                    <p class="text-gray-500 dark:text-neutral-400">
                        Hi there, my name is Javier. I'm a passionate of
                        technology, I like build complex web sites and try new
                        things relaed to Artificial Intelligence and Data
                        Science, and currently I'm also teaching at the
